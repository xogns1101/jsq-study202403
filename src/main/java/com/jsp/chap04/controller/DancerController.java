...
public class DancerController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            switch(requestURI) {
                case "/register.do":
                    System.out.println("등록 폼으로 이동시켜달라는 요청이구나!");
                ...
                case "/regist.do":
                    ...
                    // 서비스가 댄서 목록을 request 에 담아놓은 상태입니다.
                    // 디스패처에게 목적지를 알려주면서, request 와 response 객체를 가지고 이동하라는 명령을 내립니다.
                    // 실제 페이지가 목적지로 이동되면서, request 와 response 객체도 함께 전달됩니다.
                    // -> jsp 에서 request 를 꺼내서 목록을 화면에 뿌려서 응답하면 끝!
